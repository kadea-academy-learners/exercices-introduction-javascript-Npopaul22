...
// Répartition 75% pour Paul, Marie et Éric
...
// Répartition 25% pour Claire, Madame MUKUNA, Joseph et Sarah
const claire = (totalHeritage * 0.25) / 6;       // 15 000 000
const madameMukuna = (totalHeritage * 0.25) / 12; // 10 000 000
const joseph = (totalHeritage * 0.25) / 12;       // 10 000 000
const sarah = (totalHeritage * 0.25) / 12;        // 10 000 000
